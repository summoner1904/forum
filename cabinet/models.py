...
class UserProfile(AbstractUser):
    # Стандартное изображение профиля нового пользователя
    DEFAULT = 'images_profile/2023-05-27/caf098e477ae55905890b7fb0b3700c1.jpg'

    date_joined = models.DateTimeField(verbose_name="date joined",
                                       auto_now_add=True)
    status = models.CharField(max_length=128, blank=True)
    date_birthday = models.DateField(
        blank=True, null=True, default="1970-01-01",
    ...
    steam = models.CharField(
        max_length=64, default="Неизвестно", null=True,
        verbose_name="Steam", blank=True
    )
    ...
    gender = models.CharField(
        max_length=16, default="Не указан", null=True, verbose_name="Пол"
    )
    ...
    avatar = models.ImageField(
        upload_to="images_profile/%Y-%m-%d",default=DEFAULT,
    )
