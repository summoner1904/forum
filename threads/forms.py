...
class NewThreadForm(forms.Form):
    ...
    category = forms.ModelChoiceField(queryset=Category.objects.all(), empty_label=None, widget=forms.Select(attrs={'style': 'background: #2f2f2f;color: white;width: 60%;height:40px;border:none;outline:none;padding-left:10px;'}), label='Категория')
